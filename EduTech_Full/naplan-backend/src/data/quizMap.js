...
const YEAR_3 = {
  ...
  A: [
    { quiz_id: "87c82fac-2a4e-486d-b566-8200514fa7fc", quiz_name: "Year 3 Writing", subject: "Writing" },
    { quiz_id: "6db1c3ab-db7c-402d-b08d-45f5fc8a48b3", quiz_name: "Year 3 Reading", subject: "Reading" },
    { quiz_id: "2782fc4e-548e-4782-81dc-321c81101742", quiz_name: "Year 3 Reading Set 2", subject: "Reading" },
    { quiz_id: "7a5a06c3-7bdb-47ba-bcf4-182d105710cf", quiz_name: "Year 3 Numeracy", subject: "Maths" },
    { quiz_id: "7474b871-b2f4-44c3-ac4a-788aca433ae8", quiz_name: "Year 3 Numeracy Set 2", subject: "Maths" },
  ],

  // Tier B: Standard/medium topic quizzes
  B: [
    { quiz_id: "ca3c6d7f-5370-41a4-87f7-8e098d762461", quiz_name: "Year 3 Medium Number and Algebra", subject: "Maths" },
    { quiz_id: "6cb798a7-a5cb-44c2-a587-1c92b899b3d5", quiz_name: "Year 3 Medium Grammar & Punctuation Set 2", subject: "Conventions" },
    { quiz_id: "f1a0e888-e486-4049-826c-ce39f631ec5d", quiz_name: "Year 3 Language Full Set 2", subject: "Conventions" },
  ],

  // Tier C: Hard topic quizzes
  C: [
    { quiz_id: "79b9e678-59b0-4db3-a59f-99398c036015", quiz_name: "Year 3 Hard Grammar & Punctuation Set 2", subject: "Conventions" },
  ],
};
