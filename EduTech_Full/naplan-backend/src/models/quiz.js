/**
 * models/quiz.js  (v3 — GAPS FILLED + RANDOMIZE + MEDIA)
 *
 ...
 *   ✅ NEW: randomize_options — quiz-level fallback for option shuffling
 *   ✅ NEW: voice_url — audio resource URL
 *   ✅ NEW: video_url — video resource URL
 */
