...
export default function FreeTrialPage() {
  ...
  const FLEXIQUIZ_URL = 'https://www.flexiquiz.com/SampleTestURL'
  ...
  return (
    ...
    >
      <div className="max-w-3xl w-full text-center">
        ...
        {/* Headline */}
        <h1 className="text-3xl md:text-5xl font-bold mb-6 text-indigo-600">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
          ...
          <motion.button
            onClick={() =>
              window.open(FLEXIQUIZ_URL, '_blank', 'noopener,noreferrer')
            }
